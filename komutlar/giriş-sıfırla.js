...
exports.run = async (client, message, args) => {
    ...
    if (hgbbkanal) {
        ...
        message.channel.send(`:white_check_mark: Giriş kanalı başarılı bir şekilde sıfırlandı.`)
    } else {
        if (!hgbbkanal) {

            return message.channel.send(`:warning: Bu sunucuda daha önceden ayarlanmış kanal mevcut değil. Ayarlamak için: giriş-ayarla`)
